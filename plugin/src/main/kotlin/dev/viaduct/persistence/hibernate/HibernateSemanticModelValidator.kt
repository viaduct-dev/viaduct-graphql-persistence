...
internal class HibernateSemanticModelValidator(
    ...
    private fun nullabilityError(
        entity: PersistenceEntity,
        fieldName: String,
    ): String = "Hibernate mapping for ${entity.graphqlName}.$fieldName changes GraphQL nullability"
}
